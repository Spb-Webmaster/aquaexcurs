<div class="modal-form-container mini  app_form_modal">
    ...
    <div class="modal_padding relative app_modal ">
        <div class="form_title">
            ...
            <div class="form_title__h2">Парт Укажите свой номер телефона, мы свяжемся с  вами в ближайшее
                время.</div>
        </div>
      ...
      {{--          autofocus="{{ true }}"--}}
        ...
        <div class="input-button ">
            <x-form.form-button class="w_265_px_important"  url="order_excursion_motor-ship" >Отправить</x-form.form-button>
        </div>
    </div>
    @endif
</div>
